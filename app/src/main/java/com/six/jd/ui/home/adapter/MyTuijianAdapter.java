...
class MyTuijianAdapter extends RecyclerView.Adapter<MyTuijianAdapter.TextHolder> {


    private Context context;
    private HomeBannerBean.DataBean.TuijianBean list;

    public MyTuijianAdapter(Context context, HomeBannerBean.DataBean.TuijianBean list) {
    ...
    @NonNull
    @Override
    public MyTuijianAdapter.TextHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = View.inflate(context, R.layout.home_recycleview_item, null);

        return new MyTuijianAdapter.TextHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull MyTuijianAdapter.TextHolder holder, int position) {
